        ...
        <jsp:include page="/design/admin_menu.html"></jsp:include>
            <div>
                ...
                <tr>
                    ...
                    <td>
                        <a href="allNonActiveStudents.jsp?opn=active&sid=<%=dto.getSid()%>" >Active</a>
                        <a href="allNonActiveStudents.jsp?opn=delete&sid=<%=dto.getSid()%>" >Delete</a>
                ...
                %>
                <center>
                    <h1 style="color: white">There is no any inactive students</h1>
                </center>
                <%
                    }
                %>
