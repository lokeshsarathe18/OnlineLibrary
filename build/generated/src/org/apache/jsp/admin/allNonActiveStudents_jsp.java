...
public final class allNonActiveStudents_jsp extends org.apache.jasper.runtime.HttpJspBase
    ...
    try {
      ...
      out.write("                ");
                    ...
                    if (opn != null && sid != null) {
                        if (opn.equalsIgnoreCase("delete")) {
                            dao.deleteStudent(Integer.parseInt(sid));
                        } else {
                            dao.activeStudent(Integer.parseInt(sid));
                        }
                    }

                    ArrayList<StudentDto> list = dao.getAllNonActiveStudents();
                    if (list != null) {
                        int s = 0;
      ...
      out.write("                    </td>\n");
      out.write("                    <td>\n");
      out.write("                        <a href=\"allNonActiveStudents.jsp?opn=active&sid=");
      out.print(dto.getSid());
      out.write("\" >Active</a>\n");
      out.write("                        <a href=\"allNonActiveStudents.jsp?opn=delete&sid=");
      out.print(dto.getSid());
      out.write("\" >Active</a>\n");
      out.write("\n");
      out.write("                    </td>\n");
